 ...
 */
geoTool.LatLongToOSGrid = function(p) {
 ...
 */
geoTool.OSGridToLatLong = function(gridRef) {
  var gr = this.gridrefLetToNum(gridRef);
  var E = gr[0], N = gr[1];
 ...
 */
geoTool.gridrefLetToNum = function(gridref) {
 ...
 */
geoTool.gridrefNumToLet = function(e, n, digits) {
